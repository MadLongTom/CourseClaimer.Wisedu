...
{ 
    ...
    public class Const
    {
        ...
        /// OCR旧版识别字符集
        /// </summary>
        public static readonly string[] OCR_OLD_CHARSET = new string[]{"", "掀", "袜", "顧", "徕", "榱", "荪", "浡", "其", "炎", "玉", "恩", "劣", "徽",
                                  "廉", "桂", "拂",
                                  "鳊", "撤",
        ...
        /// OCR新版识别字符集
        /// </summary>
        public static readonly string[] OCR_BETA_CHARSET = new string[] { "", "笤", "谴", "膀", "荔", "佰", "电", "臁", "矍", "同", "奇", "芄", "吠", "6",
